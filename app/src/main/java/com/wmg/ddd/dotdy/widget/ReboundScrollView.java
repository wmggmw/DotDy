...
public class ReboundScrollView extends ScrollView {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        Log.i("wmgTest", "************ originalRect.top= " + originalRect.top);
    }
...
//                Log.i("wmgTest", "isMoved= " + isMoved);
                if(!isMoved) break;  //如果没有移动布局， 则跳过执行
//                Log.i("wmgTest", "after ");

                Log.i("wmgTest", "contentView.getTop()= " + contentView.getTop());
...
//                    break;
                ...
                if(shouldMove){
//                    Log.i("wmgTest", "shouldMove= " + shouldMove);
                    //计算偏移量
                    int offset = (int)(deltaY * MOVE_FACTOR);

                    Log.i("wmgTest", "offset= " + offset + "   " + (originalRect.top + offset));
